...
// Filename: Domestic_istar_3a.mod
// Examine the effect of foreign-interest-rate shock istar under an interest rate policy that targets domestic inflation
...
// Uncovered interest rate parity (UIP) (Modified for determinacy)
delta_e = i(-1) - istar(-1) - 0.1*tau;
